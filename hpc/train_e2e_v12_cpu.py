...
def sample_prior(n_samples: int, prior_df: pd.DataFrame) -> pd.DataFrame:
    ...
    # 2. POMDP introduces historical priors using subject-specific mean and std
...
def generate_data(n_samples=5000, part_id=1):
    ...
    # Incorporate the part_id into the filename
    dataset_file = BASE_DIR / f"e2e_dataset_{n_samples}_{FUSION_MODE}_finetune_part_{part_id}.pt"
