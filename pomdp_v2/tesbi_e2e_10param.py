...
PARAM_RANGES = {
    ...
    "cost_go_error":   (0.01, 2.0), 
    "cost_go_missing": (0.01, 2.0),
    "inv_temp":        (10.0, 100.0),
...
DATASET_PATH = ART_DIR / "simulated_dataset_10p.pt"
MODEL_PATH = ART_DIR / "amortized_inference_net_10p.pth"
RECOVERY_CSV = ART_DIR / "params_recovery_10p.csv"
POST_SUMMARY_CSV = ART_DIR / "params_posteriors_10p.csv"
