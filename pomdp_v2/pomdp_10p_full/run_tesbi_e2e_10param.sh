#!/bin/bash -l
#SBATCH --job-name=TeSBI_E2E_10Param
...
#SBATCH --output=slurm_tesbi_e2e_10p-%j.out
...
echo -e "\n================================================================"
echo ">>> STEP 1: Running 10-Parameter E2E Pipeline at $(date)"
echo "================================================================"

srun python3 -u tesbi_e2e_10param.py \
    --stage all \
    --n_sims ${N_SIMS} \
    --epochs ${EPOCHS} \
...
srun python3 -u fig_ppc_reps_10p.py \
    --sst_folder "${SST_FOLDER}" \
    --filter_csv "${FILTER_CSV}"
...
FINAL_OUT_DIR="${SLURM_SUBMIT_DIR}/outputs_run_${SLURM_JOB_ID}_10p"
