...
def select_representative_subjects(ppc_file, filter_file):
    ...
    if df_dist.empty:
        raise ValueError("No matching baseline subjects found in the PPC metrics file.")
...
def main():
    ...
    # Derived paths based on outputs generated by ppc_10p.py and tesbi_e2e_10param.py
