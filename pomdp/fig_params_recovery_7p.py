...
DATA_DIR = PROJECT_ROOT / "pomdp"
OUT_DIR = PROJECT_ROOT / "pomdp"

OUT_DIR.mkdir(parents=True, exist_ok=True)

RECOVERY_CSV = DATA_DIR / "params_recovery_7p.csv"
OUTPUT_PLOT = OUT_DIR / "fig_params_recovery_7p.png" 

# 7 Parameters
PARAMS = [
    "q_d_n", "q_d", "q_s", 
    "inv_temp", "cost_stop_error", 
    "cost_time", "cost_go_error"
]
...
def plot_recovery_grid(df, params, output_path):
    ...
    for i, param in enumerate(params):
        ...
        x, y = remove_outliers(x_raw, y_raw, lower_pct=1.0, upper_pct=99.0)
